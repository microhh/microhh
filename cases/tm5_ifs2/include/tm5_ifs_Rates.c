...
//Depositions: values are in cm/s and we assume a 1000 m high box...making the uC_M,-11000.,-11080.,TEMP)+7.348E-5)
...
double vdc2o3 = 2.0 / 1.E5;
double vdhcho = 0.33 / 1.E5;
double vdpan = 0.13 / 1.E5;
...
/* End INLINED RCONST                                               */
  ...
  RCONST[18] = (ARR3(6.9E-12,-1000.,TEMP)+ARR3(7.6E-12,-585.,TEMP));
  RCONST[19] = (2.7E-06);
  RCONST[20] = (8.9E-03);
  RCONST[21] = (2.845E-05);
  RCONST[22] = (3.734E-05);
  RCONST[23] = (5.531E-06);
  RCONST[24] = (8.881E-06);
  RCONST[25] = (TROE_kmeno2(9.7E-29,5.6,9.3E-12,1.5,0.3,C_M,TEMP));
  RCONST[26] = (TROE_kmeno2(9.7E-29,5.6,9.3E-12,1.5,0.3,C_M,
              TEMP)/ARR3(9.E-29,14000.,TEMP));
  RCONST[27] = (1.122E-6);
  RCONST[28] = (ARR3(1.4E-13,-2470.,TEMP));
  RCONST[29] = (ARR3(1.8E-11,110.,TEMP));
  RCONST[30] = (TROE_ifs(3.6E-30,4.1,1.9E-12,-0.2,10.,C_M,TEMP));
  RCONST[31] = ((TROE_ifs2(1.3E-3,-3.5,9.7E14,0.1,10.,C_M,-11000.,
              -11080.,TEMP)+7.348E-5));
  RCONST[35] = (erh);
  RCONST[36] = (eno);
  RCONST[37] = (vdo3);
