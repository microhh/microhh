...
figure()
subplot(121)
pcolormesh(data32_42.xh, data32_42.z, data32_42.u[:,0,:])
xlim(min(data32_42.xh), max(data32_42.xh))
ylim(min(data32_42.z) , max(data32_42.z ))
xlabel('x')
ylabel('z')
title('u')
colorbar()
subplot(122)
pcolormesh(data32_42.xh, data32_42.z, ref32_42.u[:,0,:])
xlim(min(data32_42.xh), max(data32_42.xh))
ylim(min(data32_42.z ), max(data32_42.z ))
xlabel('x')
ylabel('z')
...
figure()
subplot(121)
pcolormesh(data32_42.x, data32_42.zh, data32_42.w[:,0,:])
xlim(min(data32_42.x ), max(data32_42.x ))
ylim(min(data32_42.zh), max(data32_42.zh))
xlabel('x')
ylabel('z')
title('w')
colorbar()
subplot(122)
pcolormesh(data32_42.x, data32_42.zh, ref32_42.w[:,0,:])
xlim(min(data32_42.x ), max(data32_42.x ))
ylim(min(data32_42.zh), max(data32_42.zh))
xlabel('x')
ylabel('z')
...
figure()
subplot(121)
pcolormesh(data32_42.x, data32_42.z, data32_42.p[:,0,:])
xlim(min(data32_42.x), max(data32_42.x))
ylim(min(data32_42.z), max(data32_42.z))
xlabel('x')
ylabel('z')
...
colorbar()
subplot(122)
pcolormesh(data32_42.x, data32_42.z, ref32_42.p[:,0,:])
xlim(min(data32_42.x), max(data32_42.x))
ylim(min(data32_42.z), max(data32_42.z))
xlabel('x')
ylabel('z')
...
figure()
pcolormesh(data32_42.x, data32_42.z, data32_42.p[:,0,:]-ref32_42.p[:,0,:])
xlim(min(data32_42.x), max(data32_42.x))
ylim(min(data32_42.z), max(data32_42.z))
xlabel('x')
ylabel('z')
