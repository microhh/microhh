...
colorbar()
subplot(122)
pcolormesh(data128_42.x, data128_42.z, data128_42.u[:,0,:]-ref128_42.u[:,0,:])
xlim(min(data128_42.xh), max(data128_42.xh))
ylim(min(data128_42.z ), max(data128_42.z ))
xlabel('x')
ylabel('z')
...
colorbar()
subplot(122)
pcolormesh(data128_42.x, data128_42.z, data128_42.w[:,0,:]-ref128_42.w[:,0,:])
xlim(min(data128_42.x ), max(data128_42.x ))
ylim(min(data128_42.zh), max(data128_42.zh))
xlabel('x')
ylabel('z')
...
colorbar()
subplot(122)
pcolormesh(data128_42.x, data128_42.z, data128_42.p[:,0,:]-ref128_42.p[:,0,:])
xlim(min(data128_42.x), max(data128_42.x))
ylim(min(data128_42.z), max(data128_42.z))
xlabel('x')
ylabel('z')
