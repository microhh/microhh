...
if __name__ == '__main__':
    ...
    def generate_case(use_rt, homogenize_sw=False, homogenize_lw=False, homogenize_hr=False, spppsqp=256):
        ...
        if homogenize_sw or homogenize_lw or homogenize_hr:
            job_name += '_hom'
        else:
            job_name += '_het'
        ...
        ini['radiation']['swhomogenizehr'] = homogenize_hr
    ...
    generate_case(use_rt=True, homogenize_hr=True)
    generate_case(use_rt=False, homogenize_hr=True)
