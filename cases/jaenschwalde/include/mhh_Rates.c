...
/* End INLINED RCONST                                               */
  ...
  RCONST[9] = (TROE_ifs(3.6E-30,4.1,1.9E-12,-0.2,10.,C_M,TEMP));
  RCONST[10] = (TROE_ifs2(1.3E-3,-3.5,9.7E14,0.1,10.,C_M,-11000.,
              -11080.,TEMP));
  RCONST[11] = (ARR3(3.3E-12,270.,TEMP));
  RCONST[12] = (TROE_no2oh(3.2E-30,4.5,3.E-11,10.,C_M,TEMP));
  RCONST[14] = (RK28(2.4E-14,460.,6.51E-34,1335.,2.69E-17,2199.,C_M,
              TEMP));
  RCONST[16] = (ARR3(2.45E-12,-1775.,TEMP));
  RCONST[17] = (ARR3(3.8E-13,780.,TEMP)*(1.-(1./(1.+ARR3(498.,-1160.,
              TEMP)))));
  RCONST[18] = (ARR3(3.8E-13,780.,TEMP)*(1./(1.+ARR3(498.,-1160.,
              TEMP))));
  RCONST[19] = (ARR3(2.8E-12,300.,TEMP));
