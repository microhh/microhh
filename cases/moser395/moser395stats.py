...
# read Moser's data
Mosermean = numpy.loadtxt("chan395.means", skiprows=25)
Moserrey  = numpy.loadtxt("chan395.reystress", skiprows=25)
Moseru2   = numpy.loadtxt("chan395.uubal", skiprows=25)
Moserv2   = numpy.loadtxt("chan395.wwbal", skiprows=25)
Moserw2   = numpy.loadtxt("chan395.vvbal", skiprows=25)
Mosertke  = numpy.loadtxt("chan395.kbal" , skiprows=25)
Moseruw   = numpy.loadtxt("chan395.uvbal", skiprows=25)
...
stats = netCDF4.Dataset("moser395.default.0000000.nc","r")
