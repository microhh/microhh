...
runtime_in = nml["time_control"]["run_days"]*86400 + nml["time_control"]["run_hours"]*3600 + nml["time_control"]["run_minutes"]*60 + nml["time_control"]["run_seconds"]
...
#Modify .ini file: Add comments for case description; Alter lines where necessary.
...
nc_file = nc.Dataset("testbed_input.nc", mode="w", datamodel="NETCDF4", clobber=False)
