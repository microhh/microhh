...
# read Moser's data
Mosermean = numpy.loadtxt("../moser180/chan180.means", skiprows=25)
Moserrey  = numpy.loadtxt("../moser180/chan180.reystress", skiprows=25)
Moseru2   = numpy.loadtxt("../moser180/chan180.uubal", skiprows=25)
Moserv2   = numpy.loadtxt("../moser180/chan180.wwbal", skiprows=25)
Moserw2   = numpy.loadtxt("../moser180/chan180.vvbal", skiprows=25)
Mosertke  = numpy.loadtxt("../moser180/chan180.kbal" , skiprows=25)
Moseruw   = numpy.loadtxt("../moser180/chan180.uvbal", skiprows=25)
...
if(plotens):
  for n in range(end-start):
    plot(yplus[starty:endy], b2_sheart[n,starty:endy], color='#cccccc')
    plot(yplus[starty:endy], b2_turbt [n,starty:endy], color='#cccccc')
    plot(yplus[starty:endy], b2_visct [n,starty:endy], color='#cccccc')
    plot(yplus[starty:endy], b2_disst [n,starty:endy], color='#cccccc')
plot(yplus[starty:endy], b2_shear[starty:endy], 'b-', label='S')
plot(yplus[starty:endy], b2_turb [starty:endy], 'g-', label='Tt')
plot(yplus[starty:endy], b2_visc [starty:endy], 'c-', label='Tv')
plot(yplus[starty:endy], b2_diss [starty:endy], 'r-', label='D')
plot(yplus[starty:endy], b2_resid[starty:endy], 'k-', label='resid')
xlabel('y+')
ylabel('B2')
legend(loc=0, frameon=False)
grid()
