...
int InitSaveData()
{
  fpDat = fopen("orlando.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : orlando.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("orlando.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : orlando.m");
    exit(1);
  }

  fprintf(fpMatlab, "load orlando.dat;\n");
  fprintf(fpMatlab, "%sc = orlando;\n", prefix);
  fprintf(fpMatlab, "clear orlando;\n");
