...
int InitSaveData()
{
  fpDat = fopen("orlando_ohss.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : orlando_ohss.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("orlando_ohss.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : orlando_ohss.m");
    exit(1);
  }

  fprintf(fpMatlab, "load orlando_ohss.dat;\n");
  fprintf(fpMatlab, "%sc = orlando_ohss;\n", prefix);
  fprintf(fpMatlab, "clear orlando_ohss;\n");
