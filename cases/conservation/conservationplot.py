...
figure()
subplot(131)
plot(time100_2nd[1:200], mom100_2nd [1:200] - mom100_2nd [1], 'b-' , label = 'cfl08_2nd' )
plot(time100_4th[1:200], mom100_4th [1:200] - mom100_4th [1], 'r-' , label = 'cfl08_4th' )
plot(time200_2nd[1:400], mom200_2nd [1:400] - mom200_2nd [1], 'b--', label = 'cfl04_2nd' )
plot(time200_4th[1:400], mom200_4th [1:400] - mom200_4th [1], 'r--', label = 'cfl04_4th' )
plot(time400_2nd[1:800], mom400_2nd [1:800] - mom400_2nd [1], 'b:' , label = 'cfl02_2nd' )
plot(time400_4th[1:800], mom400_4th [1:800] - mom400_4th [1], 'r:' , label = 'cfl02_4th' )
legend(loc=0, frameon=False)
title('momentum conservation')
subplot(132)
plot(time100_2nd[1:200], tke100_2nd [1:200] - tke100_2nd [1], 'b-' , label = 'cfl08_2nd' )
plot(time100_4th[1:200], tke100_4th [1:200] - tke100_4th [1], 'r-' , label = 'cfl08_4th' )
plot(time200_2nd[1:400], tke200_2nd [1:400] - tke200_2nd [1], 'b--', label = 'cfl04_2nd' )
plot(time200_4th[1:400], tke200_4th [1:400] - tke200_4th [1], 'r--', label = 'cfl04_4th' )
plot(time400_2nd[1:800], tke400_2nd [1:800] - tke400_2nd [1], 'b:' , label = 'cfl02_2nd' )
plot(time400_4th[1:800], tke400_4th [1:800] - tke400_4th [1], 'r:' , label = 'cfl02_4th' )
legend(loc=0, frameon=False)
title('energy conservation')
subplot(133)
plot(time100_2nd[1:200], mass100_2nd[1:200] - mass100_2nd[1], 'b-' , label = 'cfl08_2nd')
plot(time100_4th[1:200], mass100_4th[1:200] - mass100_4th[1], 'r-' , label = 'cfl08_4th')
plot(time200_2nd[1:400], mass200_2nd[1:400] - mass200_2nd[1], 'b--', label = 'cfl04_2nd')
plot(time200_4th[1:400], mass200_4th[1:400] - mass200_4th[1], 'r--', label = 'cfl04_4th')
plot(time400_2nd[1:800], mass400_2nd[1:800] - mass400_2nd[1], 'b:' , label = 'cfl02_2nd')
plot(time400_4th[1:800], mass400_4th[1:800] - mass400_4th[1], 'r:' , label = 'cfl02_4th')
legend(loc=0, frameon=False)
