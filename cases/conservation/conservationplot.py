...
figure()
subplot(131)
plot(time100_3rd[1:100], mom100_3rd [1:100] - mom100_3rd [1], 'b-' , label='cfl08_3rd')
plot(time100_4th[1:100], mom100_4th [1:100] - mom100_4th [1], 'r-' , label='cfl08_4th')
plot(time200_3rd[1:200], mom200_3rd [1:200] - mom200_3rd [1], 'b--', label='cfl04_3rd')
plot(time200_4th[1:200], mom200_4th [1:200] - mom200_4th [1], 'r--', label='cfl04_4th')
plot(time400_3rd[1:400], mom400_3rd [1:400] - mom400_3rd [1], 'b:' , label='cfl02_3rd')
plot(time400_4th[1:400], mom400_4th [1:400] - mom400_4th [1], 'r:' , label='cfl02_4th')
legend(loc=0, frameon=False)
title('momentum conservation')
subplot(132)
plot(time100_3rd[1:100], tke100_3rd [1:100] - tke100_3rd [1], 'b-' , label='cfl08_3rd')
plot(time100_4th[1:100], tke100_4th [1:100] - tke100_4th [1], 'r-' , label='cfl08_4th')
plot(time200_3rd[1:200], tke200_3rd [1:200] - tke200_3rd [1], 'b--', label='cfl04_3rd')
plot(time200_4th[1:200], tke200_4th [1:200] - tke200_4th [1], 'r--', label='cfl04_4th')
plot(time400_3rd[1:400], tke400_3rd [1:400] - tke400_3rd [1], 'b:' , label='cfl02_3rd')
plot(time400_4th[1:400], tke400_4th [1:400] - tke400_4th [1], 'r:' , label='cfl02_4th')
legend(loc=0, frameon=False)
title('energy conservation')
subplot(133)
plot(time100_3rd[1:100], mass100_3rd[1:100] - mass100_3rd[1], 'b-' , label='cfl08_3rd')
plot(time100_4th[1:100], mass100_4th[1:100] - mass100_4th[1], 'r-' , label='cfl08_4th')
plot(time200_3rd[1:200], mass200_3rd[1:200] - mass200_3rd[1], 'b--', label='cfl04_3rd')
plot(time200_4th[1:200], mass200_4th[1:200] - mass200_4th[1], 'r--', label='cfl04_4th')
plot(time400_3rd[1:400], mass400_3rd[1:400] - mass400_3rd[1], 'b:' , label='cfl02_3rd')
plot(time400_4th[1:400], mass400_4th[1:400] - mass400_4th[1], 'r:' , label='cfl02_4th')
legend(loc=0, frameon=False)
...
dts           = array([8., 4., 2.])
tkelosses_3rd = array([tkeloss100_3rd, tkeloss200_3rd, tkeloss400_3rd])
