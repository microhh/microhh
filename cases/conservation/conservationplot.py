...
subplot(132)
plot(time100_2nd[1:200], tke100_2nd [1:200] - tke100_2nd [1], 'g-' , label = 'tkediff100 ')
plot(time200_2nd[1:400], tke200_2nd [1:400] - tke200_2nd [1], 'g--', label = 'tkediff200 ')
plot(time400_2nd[1:800], tke400_2nd [1:800] - tke400_2nd [1], 'g:' , label = 'tkediff400 ')
legend(loc=0, frameon=False)
subplot(133)
plot(time100_2nd[1:200], mass100_2nd[1:200] - mass100_2nd[1], 'r-' , label = 'massdiff100')
plot(time200_2nd[1:400], mass200_2nd[1:400] - mass200_2nd[1], 'r--', label = 'massdiff200')
plot(time400_2nd[1:800], mass400_2nd[1:800] - mass400_2nd[1], 'r:' , label = 'massdiff400')
legend(loc=0, frameon=False)

figure()
subplot(131)
plot(time100_4th[1:200], mom100_4th [1:200] - mom100_4th [1], 'b-' , label = 'momdiff100 ')
plot(time200_4th[1:400], mom200_4th [1:400] - mom200_4th [1], 'b--', label = 'momdiff200 ')
plot(time400_4th[1:800], mom400_4th [1:800] - mom400_4th [1], 'b:' , label = 'momdiff400 ')
legend(loc=0, frameon=False)
subplot(132)
plot(time100_4th[1:200], tke100_4th [1:200] - tke100_4th [1], 'g-' , label = 'tkediff100 ')
plot(time200_4th[1:400], tke200_4th [1:400] - tke200_4th [1], 'g--', label = 'tkediff200 ')
plot(time400_4th[1:800], tke400_4th [1:800] - tke400_4th [1], 'g:' , label = 'tkediff400 ')
legend(loc=0, frameon=False)
subplot(133)
