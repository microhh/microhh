...
int InitSaveData()
{
  fpDat = fopen("tm5_ifs_ohss.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : tm5_ifs_ohss.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("tm5_ifs_ohss.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : tm5_ifs_ohss.m");
    exit(1);
  }

  fprintf(fpMatlab, "load tm5_ifs_ohss.dat;\n");
  fprintf(fpMatlab, "%sc = tm5_ifs_ohss;\n", prefix);
  fprintf(fpMatlab, "clear tm5_ifs_ohss;\n");
