...
/*                                                                  */
/* File                 : tm5_ifs_ohss_Integrator.c                 */
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{   
   double Ynew[12], Fcn0[12], Fcn[12],
      dFdT[12],
      Jac0[59], Ghimj[59];
   double K[12*ros_S];   
   double H, T, Hnew, HC, HG, Fac, Tau; 
   double Err, Yerr[12];
   int Pivot[12], Direction, ioffset, j, istage;
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
  ...
  /*~~~>   Compute the stages  */
   for (istage = 1; istage <= ros_S; istage++) {
      ...
      /* Current istage offset. Current istage vector is K[ioffset:ioffset+12-1] */
      ioffset = 12*(istage-1);
	 
      /* For the 1st istage the function has been computed previously */
      if ( istage == 1 )
	   WCOPY(12,Fcn0,1,Fcn,1);
      else { /* istage>1 and a new function evaluation is needed at current istage */
	if ( ros_NewF[istage-1] ) {
	   WCOPY(12,Y,1,Ynew,1);
	   for (j = 1; j <= istage-1; j++)
	     WAXPY(12,ros_A[(istage-1)*(istage-2)/2+j-1],
                   &K[12*(j-1)],1,Ynew,1); 
  ...
  /*~~~>  Compute the new solution   */
   WCOPY(12,Y,1,Ynew,1);
   for (j=1; j<=ros_S; j++)
       WAXPY(12,ros_M[j-1],&K[12*(j-1)],1,Ynew,1);

  /*~~~>  Compute the error estimation   */
   WSCAL(12,ZERO,Yerr,1);
   for (j=1; j<=ros_S; j++)    
       WAXPY(12,ros_E[j-1],&K[12*(j-1)],1,Yerr,1);
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/   
{
  /*~~~> Local variables */     
   ...
   WAXPY(12,(-ONE),Fcn0,1,dFdT,1);
   WSCAL(12,(ONE/Delta),dFdT,1);
...
{   
  ...
  /*~~~>    Construct Ghimj = 1/(H*ham) - Jac0 */
     WCOPY(59,Jac0,1,Ghimj,1);
     WSCAL(59,(-ONE),Ghimj,1);
...
{   
  ...
  /*~~~> Note: for a full matrix use Lapack:
      NRHS = 1
      DGETRS( 'N', 12 , NRHS, A, 12, Pivot, b, 12, INFO ) */
