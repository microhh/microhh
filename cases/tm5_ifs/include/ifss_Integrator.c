...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{   
   double Ynew[11], Fcn0[11], Fcn[11],
      dFdT[11],
      Jac0[46], Ghimj[46];
   double K[11*ros_S];   
   double H, T, Hnew, HC, HG, Fac, Tau; 
   double Err, Yerr[11];
   int Pivot[11], Direction, ioffset, j, istage;
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
  ...
  /*~~~>   Compute the stages  */
   for (istage = 1; istage <= ros_S; istage++) {
      ...
      /* Current istage offset. Current istage vector is K[ioffset:ioffset+11-1] */
      ioffset = 11*(istage-1);
	 
      /* For the 1st istage the function has been computed previously */
      if ( istage == 1 )
	   WCOPY(11,Fcn0,1,Fcn,1);
      else { /* istage>1 and a new function evaluation is needed at current istage */
	if ( ros_NewF[istage-1] ) {
	   WCOPY(11,Y,1,Ynew,1);
	   for (j = 1; j <= istage-1; j++)
	     WAXPY(11,ros_A[(istage-1)*(istage-2)/2+j-1],
                   &K[11*(j-1)],1,Ynew,1); 
  ...
  /*~~~>  Compute the new solution   */
   WCOPY(11,Y,1,Ynew,1);
   for (j=1; j<=ros_S; j++)
       WAXPY(11,ros_M[j-1],&K[11*(j-1)],1,Ynew,1);

  /*~~~>  Compute the error estimation   */
   WSCAL(11,ZERO,Yerr,1);
   for (j=1; j<=ros_S; j++)    
       WAXPY(11,ros_E[j-1],&K[11*(j-1)],1,Yerr,1);
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/   
{
  /*~~~> Local variables */     
   ...
   WAXPY(11,(-ONE),Fcn0,1,dFdT,1);
   WSCAL(11,(ONE/Delta),dFdT,1);
...
{   
  ...
  /*~~~>    Construct Ghimj = 1/(H*ham) - Jac0 */
     WCOPY(46,Jac0,1,Ghimj,1);
     WSCAL(46,(-ONE),Ghimj,1);
...
{   
  ...
  /*~~~> Note: for a full matrix use Lapack:
      NRHS = 1
      DGETRS( 'N', 11 , NRHS, A, 11, Pivot, b, 11, INFO ) */
