...
swadvec       & [grid][spatialorder] & off  & disable advection \\ 
...
swdiff        & [grid][spatialorder] & off   & disable diffusion \\
              ...
              &                      & 2smag & 2nd order smagorisnky eddy diffusion \\
dnmax         & 0.4                  &       & maximum diffusion number for numerical scheme \\
cs            & 0.23                 &       & smagorinsky constant (only valid for \textit{2smag}) \\
\end{supertabular}
\subsection*{[fields]}
\tablefirsthead{NAME & DEFAULT VALUE & OPTIONS & DESCRIPTION \\ \hline}
\tablehead{\textit{... continued from previous page} \\ NAME & DEFAULT VALUE & OPTIONS & DESCRIPTION \\ \hline}
...
spatialorder  & n/a   &  & 2nd order spatial discretization \\
