...
#ifndef USECUDA
void Boundary_bulk::calculate_du(double* restrict dutot, double* restrict u, double* restrict v, double* restrict ubot, double* restrict vbot)
{
    const int ii = 1;
...
void Boundary_bulk::momentum_fluxgrad(double* restrict ufluxbot, double* restrict vfluxbot, 
...
void Boundary_bulk::scalar_fluxgrad(double* restrict sfluxbot, double* restrict sgradbot, double* restrict s, double* restrict sbot,
...
void Boundary_bulk::surface_scaling(double* restrict ustar, double* restrict obuk, double* restrict dutot, double* restrict bfluxbot, const double Cm)
{
    const int ii = 1;
    const int jj = grid->icells;
    const int kk = grid->ijcells;
