...
int cdiff_g4::diffc(double * restrict at, double * restrict a, double * restrict dzi, double * restrict dzhi, double visc)
{
  int    ijk,kk;
...
int cdiff_g4::diffw(double * restrict wt, double * restrict w, double * restrict dzi, double * restrict dzhi, double visc)
{
  int    ijk,kk;
  int    ii1,ii2,ii3,jj1,jj2,jj3;
  double dxidxi,dyidyi;
