...
#pragma ivdep
      ...
      {
        ijk = i + j*jj;
        a[ijk] = ( - grad4xbiasbot(z[kstart-1], z[kstart], z[kstart+1], z[kstart+2])*abot 
                   + 21.*a[ijk+kk1] + 3.*a[ijk+kk2] - a[ijk+kk3] ) / 23.;
      }
  }
...
#pragma ivdep
      ...
      {
        ijk = i + j*jj + kend*kk1;
        a[ijk] = ( grad4xbiastop(z[kend-3], z[kend-2], z[kend-1], z[kend]) * atop 
                   + 21.*a[ijk-kk1] + 3.*a[ijk-kk2] - a[ijk-kk3] ) / 23.;
      }
  }
