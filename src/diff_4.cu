...
void Diff4::exec()
{
  ...
  Diff4_g::diffc<<<gridGPU, blockGPU>>>(&fields->ut->data_g[offs], &fields->u->data_g[offs],
  ...
  Diff4_g::diffc<<<gridGPU, blockGPU>>>(&fields->vt->data_g[offs], &fields->v->data_g[offs],
                                        grid->dzi4_g, grid->dzhi4_g,
                                        grid->dx, grid->dy, fields->visc,
                                        grid->icellsp, grid->ijcellsp,
                                        grid->istart, grid->jstart, grid->kstart,
  ...
  Diff4_g::diffw<<<gridGPU, blockGPU>>>(&fields->wt->data_g[offs], &fields->w->data_g[offs],
                                        grid->dzi4_g, grid->dzhi4_g,
                                        grid->dx, grid->dy, fields->visc,
                                        grid->icellsp, grid->ijcellsp,
                                        grid->istart, grid->jstart, grid->kstart,
