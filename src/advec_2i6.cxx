...
Advec_2i6<TF>::Advec_2i6(Master& masterin, Grid<TF>& gridin, Fields<TF>& fieldsin, Input& inputin) :
...
template<typename TF>
void Advec_2i6<TF>::create(Stats<TF>& stats)
{
...
template<typename TF>
void Advec_2i6<TF>::get_advec_flux(Field3d<TF>& advec_flux, const Field3d<TF>& fld)
{
    auto& gd = grid.get_grid_data();
    ...
    else if (fld.loc == gd.sloc)
    {
        ...
        throw std::runtime_error("Advec_2i6 cannot deliver flux field at that location");
}
