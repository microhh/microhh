...
int InitSaveData()
{
  fpDat = fopen("tm5_ifs.dat", "w");
  if( fpDat == 0 ) {
    printf("\n Can't create file : tm5_ifs.dat");
    exit(1);
  }
  return 0;
}
...
FILE *fpMatlab;
  ...
  fpMatlab = fopen("tm5_ifs.m", "w");
  if( fpMatlab == 0 ) {
    printf("\n Can't create file : tm5_ifs.m");
    exit(1);
  }

  fprintf(fpMatlab, "load tm5_ifs.dat;\n");
  fprintf(fpMatlab, "%sc = tm5_ifs;\n", prefix);
  fprintf(fpMatlab, "clear tm5_ifs;\n");
