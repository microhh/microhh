...
#define NREACT               43          /* Number of reactions */
#define NVARST               0           /* Starting of variables in conc. vect. */
#define NFIXST               14          /* Starting of fixed in conc. vect. */
#define NONZERO              91          /* Number of nonzero entries in Jacobian */
#define LU_NONZERO           95          /* Number of nonzero entries in LU factoriz. of Jacobian */
#define CNVAR                15          /* (NVAR+1) Number of elements in compressed row format */
#define CNEQN                44          /* (NREACT+1) Number stoicm elements in compressed col format */
#define NHESS                69          /* Length of Sparse Hessian */
