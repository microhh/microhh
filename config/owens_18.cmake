...
if(USEMPI)
  ...
  set(FFTW_INCLUDE_DIR   "/usr/local/fftw3/intel/18.0/mvapich2/2.3rc3/3.3.5/include")
  set(FFTW_LIB           "libfftw3.a")
  set(FFTWF_LIB          "libfftw3f.a")
  set(NETCDF_INCLUDE_DIR "/usr/local/netcdf/intel/18.0/mvapich2/2.3rc2/4.3.3.1/include/")
  set(NETCDF_LIB_C       "/usr/local/netcdf/intel/18.0/mvapich2/2.3rc2/4.3.3.1/lib/libnetcdf.a")
  set(NETCDF_LIB_CPP     "/usr/local/netcdf/intel/18.0/mvapich2/2.3rc2/4.3.3.1/lib/libnetcdf_c++4.a")
  set(HDF5_LIB_1         "/usr/local/hdf5/intel/18.0/mvapich2/2.3rc2/1.8.17/lib/libhdf5.a")
  set(HDF5_LIB_2         "/usr/local/hdf5/intel/18.0/mvapich2/2.3rc2/1.8.17/lib/libhdf5_hl.a")
  set(SZIP_LIB           "")
else()
  set(ENV{CC} icc) # compiler for serial build
  set(ENV{CXX} icc) # compiler for parallel build
  set(ENV{FC}  ifort)
  set(FFTW_INCLUDE_DIR   "/usr/local/fftw3/intel/18.0/mvapich2/2.2/3.3.5/include")
  set(FFTW_LIB           "libfftw3.a")
  set(FFTWF_LIB          "libfftw3f.a")
  set(NETCDF_INCLUDE_DIR "/usr/local/netcdf/intel/18.0/4.3.3.1-serial/include")
  set(NETCDF_LIB_C       "/usr/local/netcdf/intel/18.0/4.3.3.1-serial/lib/libnetcdf.a")
  set(NETCDF_LIB_CPP     "/usr/local/netcdf/intel/18.0/4.3.3.1-serial/lib/libnetcdf_c++4.a")
  set(HDF5_LIB_1         "/usr/local/hdf5/intel/18.0/1.8.17-serial/lib/libhdf5.a")
  set(HDF5_LIB_2         "/usr/local/hdf5/intel/18.0/1.8.17-serial/lib/libhdf5_hl.a")
  set(SZIP_LIB           "")
endif()
