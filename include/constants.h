...
namespace Constants
{
    ...
    //template<typename TF> constexpr TF sgstke_min = 1e-3;   // Minimum value SGS TKE [m2 s-2]
    template<typename TF> constexpr TF sgstke_min = 0.;   // Minimum value SGS TKE [m2 s-2], value from DALES.
