...
class Thermo
{
    public:
        ...
        virtual void get_aerosol_radiation_fields(std::vector<TF>&, Field3d<TF>&) = 0;
        virtual void get_aerosol_radiation_columns(std::vector<TF>&, Field3d<TF>&, std::vector<int>&, std::vector<int>&) = 0;
