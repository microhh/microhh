...
class Field3d_io
{
    public:
        ...
        int save_field3d(TF*, TF*, TF*, TF*, const char*, const TF, int, int); // Saves a full 3d field.
        int load_field3d(TF*, TF*, TF*, TF*, const char*, const TF, int, int); // Loads a full 3d field.
